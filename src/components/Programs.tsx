    ...
    <section id="program" className="py-24 px-8 md:px-20 bg-navy-dark relative overflow-hidden">
      <div className="max-w-7xl mx-auto text-center mb-16 space-y-4 relative z-10">
        <ScrollReveal animation="pop">
          <h2 className="text-5xl font-black italic text-white leading-none">PROGRAM UNGGULAN</h2>
          <p className="text-white/40 font-medium max-w-xl mx-auto italic">Inisiatif strategis Kabinet Daya Biru untuk memperkuat sinergi dan inovasi dalam lingkup maritim.</p>
        </ScrollReveal>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
        {progs.map((p, i) => (
          <ScrollReveal key={i} animation={i % 2 === 0 ? 'slide-up' : 'pop'} delay={i} className="">
            <div className="program-card relative h-96 rounded-[32px] overflow-hidden border border-white/10 shadow-2xl group cursor-pointer">
              ...
              <div className="face1 absolute inset-0 p-8 flex flex-col items-center justify-center bg-white/10 backdrop-blur-sm z-0">
                ...
                <p className="text-sm text-white/80 leading-relaxed font-light text-center">{p.desc}</p>
              </div>
